...
c="mkvmerge -o \"./demo/[$prefix] $title - $episode_number [$resolution].mkv\" --no-subtitles --no-attachments \"./video/$video\" --language 0:pl --track-name 0:Polish \"./dialogi/$subtitles\" $fonts_string"
eval $c
